...
$logo = $CI->Dashboard_data->gen_settings_data('logo')[0]['value'];
...
<body>
    <nav class="navbar navbar-expand-lg  container-fluid logo">
        <a TITLE='home page' class="navbar-brand" href="<?php echo base_url(); ?>"><img style="width: 55px;" src='<?php echo $logo; ?>'></a> 
    </nav> 
    <div class='jqheader  '>   
